...
install_rpms() {
    ...
    *)         fatal "Architecture ${arch} not supported"
    ...
    arch=$(uname -m)
    case $arch in
    "x86_64")  rpm -iUh kernel-5.10.0-60.41.0.73.oe2203.x86_64.rpm kernel-headers-5.10.0-60.41.0.73.oe2203.x86_64.rpm buildah-1.26.1-1.x86_64.rpm butane-0.14.0-1.oe2203.x86_64.rpm dumb-init-1.2.5-4.oe2203.x86_64.rpm python3-semver-2.10.2-2.oe2203.noarch.rpm containers-common-1-1.oe2203.noarch.rpm netavark-1.0.2-1.x86_64.rpm rpm-ostree-2022.16-1.x86_64.rpm rpm-ostree-devel-2022.16-1.x86_64.rpm supermin-5.3.2-1.x86_64.rpm;;
    "aarch64")  rpm -iUh kernel-5.10.0-118.0.0.64.oe2203.aarch64.rpm kernel-headers-5.10.0-118.0.0.64.oe2203.aarch64.rpm buildah-1.26.1-1.oe2203.aarch64.rpm butane-0.14.0-2.oe2203.aarch64.rpm dumb-init-1.2.5-1.oe2203.aarch64.rpm python3-semver-2.10.2-2.oe2203.noarch.rpm containers-common-1-1.oe2203.noarch.rpm netavark-1.0.2-1.oe2203.aarch64.rpm rpm-ostree-2022.16-1.aarch64.rpm rpm-ostree-devel-2022.16-1.aarch64.rpm supermin-5.3.2-1.oe2203.aarch64.rpm;;
    *)         fatal "Architecture ${arch} not supported"
    esac
